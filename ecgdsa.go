...
var (
	ErrParametersNotSetUp = errors.New("ecgdsa: parameters not set up before generating key")
	ErrInvalidASN1        = errors.New("ecgdsa: invalid ASN.1")
	ErrInvalidSignerOpts  = errors.New("ecgdsa: opts must be *SignerOpts")
)
